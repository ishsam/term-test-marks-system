  ...
  <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-top: 2%;">
    ...
    <div class="card text-white bg-secondary mb-3 " style="opacity: 0.8;">
      <div class="card-header" style="background-color: #563d7c; font-size: large;">
        <h5 class="card-title">Add Marks for <?php echo $class; ?> <?php echo $subject ?> Class </h5>
      </div>
      <div class="card-body" style="font-size: large;">
        <form method="POST" action="">
          <div class="mb-3 row">
            <div class="col-sm-3">
              <select class="form-select" id="term" name="term">
                ...
                <option <?php if($term == 1) echo ' selected'; ?> value="1">Term 1</option>
                <option <?php if($term == 2) echo ' selected'; ?>value="2">Term 2</option>
                <option <?php if($term == 3) echo ' selected'; ?>value="3">Term 3</option>
              </select>
            </div>
          </div>
          ...
          <?php if (mysqli_num_rows($student_query) != 0) echo '<button type="submit" class="btn btn-primary" name="add-marks">Add Marks</button>' ?>
        </form>
      </div>
